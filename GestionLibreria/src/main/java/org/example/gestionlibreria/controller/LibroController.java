...
public class LibroController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<Libro>> buscar(@RequestParam(required = false) String titulo, @RequestParam(required = false) String autor, @RequestParam(required = false) String genero) {
